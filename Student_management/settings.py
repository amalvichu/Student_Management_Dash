...
SECRET_KEY = 'django-insecure-bee9sj=n_dun#p^p=2z(pypxyknofj%)#%ih&v-)0a!%t+9#!a'
...
# Note: If you are using Django 3.0+ with pathlib, it might be: MEDIA_ROOT = BASE_DIR / 'media'
